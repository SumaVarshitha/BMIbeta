pipeline {
  ...
  /*  stages {
    ...
    stage('store output'){
        steps{
           sh '''
                curl  --request GET 'https://dev.azure.com/vickysastryvs/_apis/projects/abcdef1?api-version=5.1' \
                     --header 'Accept: application/json' \
                     --header 'Authorization: Basic dmlja3lzYXN0cnkudnNAb3V0bG9vay5jb206enN4YXBrajN6d2s2cnR6N3ptNHR5bGk3YXlrN3l0NXllaHA1aWM3ZXJsZWM0eHNmN3R5YQ==' -o /home/ec2-user/out.json
           '''
        }
    }
